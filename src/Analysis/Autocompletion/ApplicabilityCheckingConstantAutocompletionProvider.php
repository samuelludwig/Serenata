...
/**
 * Function autocompletion provider that first checks if constant autocompletion suggestions apply at the requested
 * offset and, if so, delegates to another provider.
 */
final class ApplicabilityCheckingConstantAutocompletionProvider implements AutocompletionProviderInterface
{
    /**

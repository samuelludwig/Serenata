...
/**
 * Local variable autocompletion provider that first checks if function autocompletion suggestions apply at the
 * requested offset and, if so, delegates to another provider.
 */
final class ApplicabilityCheckingLocalVariableAutocompletionProvider implements AutocompletionProviderInterface
{
    /**

...
/**
 * Checks if keyword autocompletion applies for a specific node.
 */
final class KeywordAutocompletionApplicabilityChecker implements AutocompletionApplicabilityCheckerInterface
{
    /**
     * @inheritDoc
     */

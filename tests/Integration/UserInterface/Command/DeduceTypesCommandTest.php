...
class DeduceTypesCommandTest extends AbstractIntegrationTest
{
    ...
    public function testCorrectlyAnalyzesTypeOverrideAnnotations(): void
    {
        ...
        $this->assertSame(['\Traversable'], $output);
    ...
    public function testCorrectlyAnalyzesNullableFunctionTypeHintsViaDefaultValue(): void
    {
        ...
        $this->assertSame(['\A\B', 'null'], $output);
    }
    /**
     * @return void
     */
    ...
    public function testCorrectlyAnalyzesCatchBlockTypeHints(): void
    {
        ...
        $this->assertSame(['\UnexpectedValueException'], $output);
    }
    ...
    public function testCorrectlyAnalyzesComplexIfStatementWithInstanceofAndAnd(): void
    {
        ...
        $this->assertSame(['\A\B', '\A\C', '\A\D'], $output);
    }
    ...
    public function testCorrectlyAnalyzesComplexIfStatementWithInstanceofAndOr(): void
    {
        ...
        $this->assertSame(['\A\B', '\A\C', '\A\D', '\A\E'], $output);
    }
    ...
    public function testCorrectlyIfStatementWithInstanceofAndOrTakesPrecedenceOverFunctionTypeHint(): void
    {
        ...
        $this->assertSame(['\A\B', '\A\C'], $output);
    }
    ...
    public function testCorrectlyAnalyzesGlobalFunctionsInNamespace(): void
    {
        ...
        $this->assertSame(['\N\B', 'null'], $result);
    }
    ...
    public function testCorrectlyAnalyzesScalarTypes(): void
    {
        ...
        $this->assertSame(['int'], $this->deduceTypesFromExpression($file, '5'));
        $this->assertSame(['int'], $this->deduceTypesFromExpression($file, '05'));
        $this->assertSame(['int'], $this->deduceTypesFromExpression($file, '0x5'));
        $this->assertSame(['float'], $this->deduceTypesFromExpression($file, '5.5'));
        $this->assertSame(['bool'], $this->deduceTypesFromExpression($file, 'true'));
        $this->assertSame(['bool'], $this->deduceTypesFromExpression($file, 'false'));
        $this->assertSame(['string'], $this->deduceTypesFromExpression($file, '"test"'));
        $this->assertSame(['string'], $this->deduceTypesFromExpression($file, '\'test\''));
        $this->assertSame(['array'], $this->deduceTypesFromExpression($file, '[$test1, function() {}]'));
        $this->assertSame(['array'], $this->deduceTypesFromExpression($file, 'array($test1, function() {})'));

        $this->assertSame(['string'], $this->deduceTypesFromExpression($file, '"
            test
        "'));

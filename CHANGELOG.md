...
* Try using workspace folders received durinig initialization if no explicit configuration is passed to support multi-folder setups without forcing explicit configuration
